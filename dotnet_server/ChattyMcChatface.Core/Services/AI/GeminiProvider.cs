...
public class GeminiProvider : IAiProvider
{
    ...
    // JSON schema definition for AiStructuredResponseDto enforced in Gemini completions
    private static readonly object ResponseSchemaDefinition = new
    {
        type = "OBJECT",
        properties = new Dictionary<string, object>
        {
            { "ai_persona", new { type = "STRING", description = "The name of the AI persona generating the response." } },
            { "response_type", new { type = "STRING", description = "The type or category of the response (e.g., \"Reflective Inquiry\", \"Sarcastic Quip\")." } },
            { "message", new { type = "STRING", description = "The actual message content generated by the AI." } }
        },
        required = new List<string> { "ai_persona", "response_type", "message" }
        // Note: Gemini doesn't seem to require 'additionalProperties: false' like OpenAI
    };
