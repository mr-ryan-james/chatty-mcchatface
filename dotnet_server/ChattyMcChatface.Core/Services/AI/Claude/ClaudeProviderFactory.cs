...
/// <summary>
/// Factory for creating configured Claude (Anthropic) completion functions.
/// </summary>
public static class ClaudeProviderFactory
{
    /// <summary>
    /// Creates a function that calls the Claude provider with a specific model ID and settings.
    /// </summary>
        ...
        double temperature = 0.7) // Default temperature if not specified
    {
        ...
        var provider = new ClaudeProvider(configuration, logger);
